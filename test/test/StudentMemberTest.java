...
public class StudentMemberTest {
	...
	public void setUp() {
		...
		stud1 = new StudentMember("joesoap@wit.ie", "Joe Soap", "wit", "M", 0, 0, "200011", null);
		studInvalid = new StudentMember("invalidstudent@wit.ie",
				"Valid name is 30 chars to hereANYTHINGAFTERTHEREISTOOLONG", "wit", "U", 0, 0, "123456789", null);
	}
	...
	public void testConstructor() {
		...
		assertEquals(35.0, studInvalid.getWeight(), 0.01);
	...
	public void testGetters() {
		...
		assertEquals(65.0, stud1.getWeight(), 0.01);
	...
	public void testSetters() {
		...
		assertEquals(65.0, stud1.getWeight(), 0.01);
		stud1.setWeight(100); // valid change
		assertEquals(100, stud1.getWeight(), 0.01);
		stud1.setWeight(34); // invalid change - too low
		assertEquals(100, stud1.getWeight(), 0.01);

		stud1.setWeight(251); // invalid change - too high
		assertEquals(100, stud1.getWeight(), 0.01);
	...
	public void testSetAssessments() {
		rocky = new Trainer("trainer@arena.ie", "Rocky Balboa", "waterford", "M", null);
		...
		stud1.setAssessments(assessments, null);
	...
	public void testToString() {
		assertEquals("StudentMember [" + "Email: " + "joesoap@wit.ie" + ", Name:" + "Joe Soap" + " (" + "M" + ")"
				+ ", Address:" + "wit" + "." + "\n\tHeight: " + 1.8 + " metres" + ",  Starting Weight: " + 65.0 + " kgs"
				+ ", StudentId=" + "200011" + " , College Name=" + "WIT" + ", Chosen Package=" + "Package 1" + "]",
				stud1.toString());
